            ...
            >
              ...
              >
                ...
                <div
                  ...
                  onClick={() => setProductItem(SLIDES[activeMobileIdx].product)}
                >
                  <img
                ...
                {/* Title with scramble */}
                <div style={{ padding: '1.25rem 6% 2rem', cursor: 'pointer' }} onClick={() => setProductItem(SLIDES[activeMobileIdx].product)}>
                  <MobileScrambleTitle
